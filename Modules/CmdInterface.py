...
class CMDInterface(cmd.Cmd):
    ...
    def do_config(self, args):
        ...
        table_config.add_row("Serial port", f"{self.faulty_worker.board_uart.serial_worker.port}")
        table_config.add_row("Pulse time", f"{self.faulty_worker.board_configurator.BOARD_CONFIG["pulse_time"]}")
        table_config.add_row("Pulse power", f"{self.faulty_worker.board_configurator.BOARD_CONFIG["pulse_power"]}")
